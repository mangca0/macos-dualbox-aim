...
from ..core.model_runtime.detector import CoreMLDetector


class RealtimeInferenceV64(RealtimeInference):
    def __init__(
        self,
        model_path: str,
        class_count: int,
        ...
        super().__init__(
            detector=_RealtimeDetectorAdapter(CoreMLDetector(model_path, class_count=class_count)),
...
class _RealtimeDetectorAdapter:
    def __init__(self, detector: CoreMLDetector):
...
__all__ = ["DetectionResult", "Frame", "RealtimeInference", "RealtimeInferenceV64"]
