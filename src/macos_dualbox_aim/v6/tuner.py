...
<body>
  ...
  <script>
    ...
    const integerFields = new Set(["fov_radius", "tracker_generate", "tracker_terminate"]);
    const metricOrder = [
    ...
    function normalizeValue(field, raw) {
      ...
      if (field === "aim_offset_dynamic") return Boolean(raw);
