...
class AimbotConfigV63:
    ...
    def version(self) -> str:
        return AIMBOT_V63_VERSION

    @classmethod
    def from_json(cls, path: str | Path) -> "AimbotConfigV63":
    ...
    def to_json(self, path: str | Path):
        data: Dict[str, Any] = {
            "_comment": "macos-dualbox-aim V6.3.0 - V6.2 plus model-driven class selection in tuner",
            "_version": AIMBOT_V63_VERSION,
        ...
        if output.exists():
            try:
                ...
                pass
        data["_version"] = AIMBOT_V63_VERSION
