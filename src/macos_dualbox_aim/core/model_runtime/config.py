...
MODEL_RUNTIME_VERSION = "core-model-runtime-1.0.0"
AIMBOT_V5_VERSION = MODEL_RUNTIME_VERSION
...
class ModelRuntimeConfig:
    ...
    @classmethod
    def from_json(cls, path: str | Path) -> "ModelRuntimeConfig":
    ...
    def to_json(self, path: str | Path) -> None:
        data: dict[str, Any] = {
            "_comment": "macos-dualbox-aim core model runtime",
            "_version": MODEL_RUNTIME_VERSION,
            "_description": "ONNX source -> Core ML packages -> adapter-based detections",
        }
...
ModelRuntimeConfigV5 = ModelRuntimeConfig
