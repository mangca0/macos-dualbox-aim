...
class WebTuner:
    ...
    def snapshot_locked(self) -> Dict[str, Any]:
        return {
            "config": {
                "tracker_generate": self.config.tracker_generate,
                "tracker_terminate": self.config.tracker_terminate,
                "tracker_vx_noise": self.config.tracker_vx_noise,
                "tracker_vy_noise": self.config.tracker_vy_noise,
                "tracker_w_noise": self.config.tracker_w_noise,
                "tracker_h_noise": self.config.tracker_h_noise,
                "tracker_r_std": self.config.tracker_r_std,
...
<body>
  ...
  <main>
    ...
    <section>
      <h2>Tracker</h2>
      <div class="field"><label for="tracker_generate">Generate</label><input id="tracker_generate" data-field="tracker_generate" type="range" min="1" max="12" step="1"><input data-number-for="tracker_generate" type="number" min="1" max="12" step="1"></div>
      ...
      <div class="field"><label for="tracker_vx_noise">Vx noise</label><input id="tracker_vx_noise" data-field="tracker_vx_noise" type="range" min="0.001" max="100" step="0.001"><input data-number-for="tracker_vx_noise" type="number" min="0.001" max="100" step="0.001"></div>
      <div class="field"><label for="tracker_vy_noise">Vy noise</label><input id="tracker_vy_noise" data-field="tracker_vy_noise" type="range" min="0.001" max="100" step="0.001"><input data-number-for="tracker_vy_noise" type="number" min="0.001" max="100" step="0.001"></div>
      <div class="field"><label for="tracker_w_noise">W noise</label><input id="tracker_w_noise" data-field="tracker_w_noise" type="range" min="0.0001" max="10" step="0.0001"><input data-number-for="tracker_w_noise" type="number" min="0.0001" max="10" step="0.0001"></div>
      <div class="field"><label for="tracker_h_noise">H noise</label><input id="tracker_h_noise" data-field="tracker_h_noise" type="range" min="0.0001" max="10" step="0.0001"><input data-number-for="tracker_h_noise" type="number" min="0.0001" max="10" step="0.0001"></div>
      <div class="field"><label for="tracker_r_std">R std</label><input id="tracker_r_std" data-field="tracker_r_std" type="range" min="0.001" max="100" step="0.001"><input data-number-for="tracker_r_std" type="number" min="0.001" max="100" step="0.001"></div>
    </section>
    <section>
      <h2>Detection</h2>
