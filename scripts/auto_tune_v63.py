...
def write_record(
    ...
    *,
    ...
    record = {
        "schema": "macos-dualbox-aim.v63.autotune_trial.v2",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Auto-tune V6.3 controller parameters through the live tuner API.")
    ...
    parser.add_argument("--auto-trigger", action="store_true", help="Keep V6.3 aim active during tuning and force-disable it on exit.")
...
def _new_output_path(out_dir: str | Path) -> Path:
    ...
    return Path(out_dir) / f"v63_auto_tune_{started_at}.jsonl"
